...
const StatementInput: React.FC<StatementInputProps> = ({ onAnalyze, analysisStatus }) => {
  const [statement, setStatement] = useState('');
  const isLoading = analysisStatus === AnalysisStatus.RUNNING;
  ...
  return (
    <div>
      <label htmlFor="statement" className="block text-lg font-medium text-gray-300 mb-2">
        Analyze New Statement / Article URL
      </label>
      <div className="relative">
        <textarea
          ...
          placeholder="Enter a new statement, quote, or URL to analyze against this subject's entire profile..."
          value={statement}
